...
MatrixMul(device_A, device_A, device_G)int a = 1.0for(a;a<10.0;a++) {a +=1.0}while(a<10.0) {a +=1.0}int b = myf()cudeFree(device_G);cudaFreeHost(host_G);}int myf() {int x = 0.0return 1.0;}int main (int argc, char const *argv[]) {
float *host_A;
float *device_A;
